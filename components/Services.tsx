...
const services = [
  {
    ...
    /* TODO: remplacer par vraie photo service chauffage */
    img: 'https://picsum.photos/seed/svc-heat/800/500',
  },
  {
    ...
    /* TODO: remplacer par vraie photo finitions */
    img: 'https://picsum.photos/seed/svc-finish/800/500',
  },
  {
    ...
    /* TODO: remplacer par vraie photo cuisine/sdb */
    img: 'https://picsum.photos/seed/svc-kitchen/800/500',
  },
]
  ...
  return (
    <section id="services" className="relative py-28 px-6 md:px-20 bg-[#0D0D0D] overflow-hidden">
      ...
      <div className="absolute -top-60 -right-60 w-[700px] h-[700px] rounded-full
                      bg-orange/5 blur-[120px] pointer-events-none animate-blob-1" />
      ...
      <motion.div
        ...
        className="mb-14"
      >
        <span className="tag-orange mb-4 block w-fit" style={{ color: '#FF8C47', borderColor: 'rgba(255,107,26,.28)', background: 'rgba(255,107,26,.1)' }}>
          🔧 Ce que nous faisons
        </span>
        <h2 className="text-4xl md:text-5xl font-semibold tracking-tight text-white mb-3 leading-[1.12]">Nos services</h2>
        ...
        {services.map((s, i) => (
          <motion.div
            ...
            className="glass-dark rounded-2xl overflow-hidden shadow-glass
                       border border-white/8 group cursor-default
          ...
          >
            ...
            <div className="relative h-44 overflow-hidden">
              ...
              <div className="absolute top-3 left-3 text-[9.5px] font-bold tracking-[2px] uppercase
                              text-orange/80 bg-black/50 backdrop-blur px-2.5 py-1 rounded-full">
                {s.n} — {s.cat}
              </div>
            </div>
            ...
            {/* Contenu */}
            <div className="p-7">
              <div className="w-10 h-10 rounded-xl bg-orange/10 flex items-center justify-center text-xl mb-4
                              group-hover:bg-orange/18 transition-colors duration-300">
                {s.icon}
              </div>
              ...
              <div className="w-6 h-px bg-orange/35 mb-4" />
