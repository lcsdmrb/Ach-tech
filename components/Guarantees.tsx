  ...
  return (
    <section className="relative py-28 px-6 md:px-20 bg-[#0D0D0D] overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2
                      w-[1000px] h-[400px] rounded-full
                      bg-orange/6 blur-[110px] pointer-events-none" />
      ...
      >
        <span className="tag-orange mb-4 inline-flex mx-auto"
              style={{ color: '#FF8C47', borderColor: 'rgba(255,107,26,.28)', background: 'rgba(255,107,26,.1)' }}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 relative z-10">
        {items.map((item, i) => (
          <motion.div
            ...
            whileHover={{ y: -5, borderColor: 'rgba(255,107,26,.3)' }}
            className="glass-dark rounded-2xl p-7 text-center
                       border border-white/8 shadow-glass
          ...
          >
            ...
            <div className="w-14 h-14 rounded-2xl bg-orange/10 flex items-center justify-center text-2xl
                            mx-auto mb-5 group-hover:bg-orange/18 transition-colors duration-300
                            shadow-[0_0_20px_rgba(255,107,26,0)]
                            group-hover:shadow-[0_0_20px_rgba(255,107,26,0.15)]">
              {item.icon}
            </div>
