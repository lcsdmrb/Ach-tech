      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {values.map((v, i) => (
          <motion.div key={v.title}
            ...
            whileHover={{ y: -6 }}
            className="glass-light rounded-2xl p-9 relative overflow-hidden group cursor-default
            ...
            <div className="text-[10px] font-bold tracking-[2px] mb-4"
                 style={{ color: 'rgba(255,107,26,0.4)' }}>{v.n}</div>
            <div className="w-12 h-12 rounded-xl flex items-center justify-center text-2xl mb-5
                            transition-colors duration-300 group-hover:scale-110 transition-transform"
